...
{/*const style = [
  
    {
      ...
      imageSrc: 'https://i.pinimg.com/564x/45/b9/28/45b928b30c352b9cc4d4bdf6fa816962.jpg',
    ...
    },
    {
      ...
      imageSrc: 'https://i.pinimg.com/564x/ca/86/d4/ca86d4c7aacb32f91e75a7895005a90f.jpg',
    ...
    },
    {
      ...
      imageSrc: 'https://i.pinimg.com/originals/33/6c/30/336c3004c0113bf6b15ed5092606f41c.jpg',
  ...
  //export default function Example() {
    export default function Example() {
      ...
      const getStyle = () => {
        Axios.get(`https://raw.githubusercontent.com/Irgyaaa/store/main/style.json`)
          .then((res) => {
            const data = res.data;
            setStyle(data.style);
          })
      ...
      <div className="bg-blue-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto py-16 sm:py-24 lg:py-32 lg:max-w-none">
            <h2 className="text-2xl font-extrabold text-yellow-500">Style</h2>
