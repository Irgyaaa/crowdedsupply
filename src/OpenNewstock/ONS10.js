        ...
        <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4 bg-blue-600">
            ...
            <div className=" grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 lg:grap-8 md:gap-6 gap-4 mt-10">
                <div className="relative group">
                    <img src="https://drive.google.com/uc?export=view&id=1lH7JXTd1z4jyab4YlwMih1rsowo-NGL2" alt="A picture of a sitting dog" className=" lg:block hidden w-full " />
                    <img src="https://drive.google.com/uc?export=view&id=1lH7JXTd1z4jyab4YlwMih1rsowo-NGL2" alt="A picture of a sitting dog" className="lg:hidden block w-full " />
                ...
                <div className="relative group">
                    <img src="https://drive.google.com/uc?export=view&id=1qy8RG0g-6J-ACGqOsjYUSOBT7B6hmlp-" alt="Smiling Girl" className=" lg:block hidden w-full " />
                    <img src="https://drive.google.com/uc?export=view&id=1qy8RG0g-6J-ACGqOsjYUSOBT7B6hmlp-" alt="Smiling Girl" className="lg:hidden block w-full " />
